...
export const AUTO_MESSAGE_TEMPLATES: AutoMessageTemplateDef[] = [
  {
    ...
    defaultText: 'Здравствуйте, {{GUEST_NAME}}! Подключитесь к нашему боту @HorizonPMSBot — там вы получите код от двери и инструкции по заезду.',
  },
  {
  ...
  persist(
    (set) => ({
      ...
      contacts: {
        ...
        email: 'info@horizon-pms.ru',
        site: 'https://horizon-pms.ru',
        whatsapp: '+74951234567',
        telegram: '@horizon_pms',
        max: '@horizon_pms',
    ...
    { name: 'horizon-settings', version: 2 },
  ),
);
