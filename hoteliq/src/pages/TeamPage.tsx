// Раздел «Команда» — директор регистрирует подчинённых и настраивает их доступ к разделам.
...
export default function TeamPage() {
  ...
  return (
    <PageTransition>
      <PageHeader
        title="Команда"
        subtitle={`${subordinates.length} сотрудников · управление доступом и ролями`}
        action={
