...
const STEPS = [
  { title: 'Добро пожаловать в GinoHotel!', text: 'Современная PMS-платформа для управления отелями и посуточной арендой. Давайте быстро покажем ключевые возможности.' },
  { title: 'Календарь броней', text: 'Перетаскивайте брони мышкой, кликайте по ячейкам для быстрого создания. Поддерживается зум день/неделя/месяц.' },
