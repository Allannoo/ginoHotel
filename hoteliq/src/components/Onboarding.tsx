...
const STEPS = [
  { title: 'Добро пожаловать в Горизонт!', text: 'Современная PMS-платформа для управления отелями и посуточной арендой. Давайте быстро покажем ключевые возможности.' },
